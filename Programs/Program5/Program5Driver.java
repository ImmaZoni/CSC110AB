//This is a driver for the BankAccount program.  It will create BankAccounts and tell them
...
public class Program5Driver
{
	public static void main(String args[])
	{
		...
		//tell it to deposit some money (should not let us - it is frozen)
		try
		{
		...
		//tell it to withdraw 40 (should not let us - it is frozen)
		try
		{
			System.out.println("\n****** Telling it to withdraw 40 (it is frozen; should throw an exception)\n");
			cash = myAccount.withdraw(40);
		}
		catch(IllegalStateException ex)
		{
			ex.printStackTrace();
		...
		try
		{
			//tell it to change its limit to 400 (should not let us - frozen)
